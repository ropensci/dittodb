...
Write tests that act like they are connected to a real-live database using `with_mock_db({...})`
...
If <5 minutes type 26 to go to the next section
...
.colophon[
slides created via the R package [**xaringan**](https://github.com/yihui/xaringan) · photos taken by Jonathan Keane, all rights reserved <br />
presentation slides + content (except for photos) are licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) <br />
]
]
